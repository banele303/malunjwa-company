...
import KitchenImage from "../../public/about-hero1.jpg";
    ...
    return (
        ...
        <div className="relative h-screen">
            ...
            <div className="relative h-[60vh] md:h-[100vh] w-full">
                <Image quality={100} src={KitchenImage} alt="our hero construction image" className="brightness-50  h-full w-full" />
