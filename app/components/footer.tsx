        ...
        <div className="dark:bg-white bg-black  dark:bg-dot-black/[0.2] bg-dot-white/[0.2] ">
            <footer className="footer p-10 grid grid-cols-1 md:grid-cols-4 gap-5">
                <aside className="flex flex-row gap-[-1rem]">
                    <div className="md:mt-[-2rem] pr-[-2rem]"> Malunjwa Company</div>
               
                    <p className="text-slate-200 mt-1">Malunjwa<br />Providing reliable Construction Services</p>
                
               
                </aside>
                <nav className="flex flex-col">
                    <h6 className="footer-title text-semibold text-slate-200 text-[17px] ">Malunjwa Construction</h6>
                    
                    <p className="link link-hover text-slate-400"><Link href="/">Home</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/about-us">Buildeing services</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/our-plumbing-services">Plumbing Services</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/about-us">Civil Works</Link> </p>
                  
                </nav>
                <nav>
                    <h6 className="footer-title  text-slate-200 text-[19px]">Construction Services</h6>
                    <p className="link link-hover text-slate-400"><Link href="/our-plumbing-services">Roofing</Link> </p>
                    <p className="link link-hover text-slate-400"><Link href="/about-us">Civil Works</Link> </p>
